        ...
        <div className="hidden lg:inline-block absolute top-0 left-0 w-full h-full">
            <div className="flex h-full flex-col gap-y-6 justify-center">
                ...
                <motion.p initial={{ y: 40, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }}
                    ...
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. <br /> Repellat, tempore!
                </motion.p>
                <motion.div
                    ...
                    <button className="py-3 px-6 rounded-full bg-slate-200">Find out more</button>
                    <button className="py-3 px-6 rounded-full bg-slate-200">Shop Now</button>
                </motion.div>
            </div>
        </div>
    )
