...
const Testimonials = () => {
    return (
        <div>
            <MultiSlider />
            <div className='w-full flex justify-center items-center bg-gradient top-0' style={{padding:'100px 0'}}>
                ...
                <div className='text-center relative'>
                    <h2 className='text-6xl font-Yesteryear mb-4 italic'>Testimonials</h2>
